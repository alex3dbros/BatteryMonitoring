...
public class CreateNewPack : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Dictionary<string, Database> dbvalues = new Dictionary<string, Database>();

        Database bg1 = new Database("Harvey", 50);
        Database bg2 = new Database("Magneto", 100);

        //You can place variables into the Dictionary with the
        //Add() method.
        dbvalues.Add("gangster", bg1);
        dbvalues.Add("mutant", bg2);

        Database magneto = dbvalues["mutant"];

        print(dbvalues["gangster"].name);
